...
function TelegramChannelSearchResult(props) {
  ...
  const url = APIConstants.TELEGRAM_API_ROOT+"/telegram/channel/search/?q=" + searchQuery;
  useEffect(() => {
    axios.get(url, {
      headers: {
...
export default TelegramChannelSearchResult;
